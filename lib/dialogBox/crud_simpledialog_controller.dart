...
class TaskController {
  ...
  static void onTapData() {
    txtImageUrlController.text = data[selectedIndex].imageurl!;

    txtFirstNameController.text = data[selectedIndex].fname!;
    txtMiddleNameController.text = data[selectedIndex].mname!;
    txtLastNameController.text = data[selectedIndex].lname!;
    txtMobileNoController.text = data[selectedIndex].mobileno!;
    txtEmailIdController.text = data[selectedIndex].emailid!;
    grpvalu = data[selectedIndex].grpvalue!;
    iscricket = data[selectedIndex].iscricket!;
    isfootball = data[selectedIndex].isfooltball!;
    isActive = data[selectedIndex].isActive!;
    agevalue = data[selectedIndex].agevalue!;
    selectedstream = data[selectedIndex].selectedstream!;
    clearData();
  }
